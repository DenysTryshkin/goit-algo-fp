...
Після виконання симуляції з великим числом кидків (наприклад, 10,000) отримані ймовірності для кожної можливої суми близькі до теоретичних значень. Це підтверджує, що симуляція правильно показує ймовірності для випадіння кожної суми на двох кубиках.

- **Висновок**: Метод Монте-Карло добре моделює ймовірності, і чим більше кидків, тим ближчі результати до теоретичних розрахунків.
